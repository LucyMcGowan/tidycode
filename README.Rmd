...
We can use the expressions from this matahari tibble extract the names of the packages included.
...
Create a dataframe of your expressions, splitting each into individual functions.
